...
.sidebar-nav { padding:9px 0; }
	...
	@media (max-width: 767px) {                                        /* для ширины меньше 767 */

		.navbar .navbar-nav>li>a { border-right: none; border-left: none; }
		#navbar-collapse-1 { padding-top: 14px }
		/*.nav.navbar-nav li:first-child { margin-top: 13px; }*/
		.navbar-nav .open .dropdown-menu { border-bottom: none !important }
		.bar-button-inline { display: block }
	...
	@media (min-width: 768px) {                                        /* для ширины больше 767 */
		/*.bar-button-inline { display: flex }*/
		.dropdown-toggle.user-button {  height: 50px; width: 57px }
...
#debug_console tr { background-color: initial !important }		
#debug_console td { color: white !important }		
#debug_console a { transform: none !important; color: white !important; }		
#debug_console a:hover { transform: none !important; color: grey !important; }		
#debug_console .nav-tabs a { margin: 0 5px; padding: 2px; border: 1px solid grey; }		
#debug_console .label-info { color: black !important; }
